...
plt.legend()
print("The generated picture cannot be displayed, you can run this code locally, or check https://github.com/nrontsis/PILCO/issues/25, the result is shown in the figure")
